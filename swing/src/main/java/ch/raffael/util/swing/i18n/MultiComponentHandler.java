 ...
 */
public class MultiComponentHandler implements ComponentHandler {

    private final ComponentHandler[] handlers;

    public MultiComponentHandler(ComponentHandler... handlers) {
    ...
    public void localize(Component component, StringLocalizer localizer, ResourceBundle bundle) {
        for ( ComponentHandler h : handlers ) {
            h.localize(component, localizer, bundle);
        }
    }
}
